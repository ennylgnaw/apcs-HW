...
public class OrderedArrayList
{
   ...
   * BEST CASE: O(1) - 1 comparison finds the correct position; when the value is less than the first element in the ordered array list

   * WORST CASE: O(n) - n comparisons; when the value is larger than all elements in the list
   ***/
   ...
   * BEST CASE: O(1) - 1 comparison; when the newVal is the median

   * WORST CASE: O(log n) - x comparisons, where n > 2^(x-1) and n < 2^x; usually when the value is not a relative median number
   ***/
